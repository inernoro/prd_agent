...
export const KNOWN_CDS_ENV_KEYS: CdsEnvKeyDef[] = [
  ...
  { key: 'CDS_SSO_AUTHORIZATION_URL', description: 'SSO 浏览器授权地址', isSecret: false, group: 'auth' },
  { key: 'CDS_SSO_TOKEN_URL', description: 'SSO 服务端换票地址', isSecret: false, group: 'auth' },
  { key: 'CDS_SSO_CLIENT_ID', description: 'SSO 客户端标识', isSecret: false, group: 'auth' },
  { key: 'CDS_SSO_CLIENT_SECRET', description: 'SSO 客户端密钥', isSecret: true, group: 'auth' },
  { key: 'CDS_SSO_DEFAULT_REDIRECT', description: 'SSO 登录成功后的 CDS 内部页面', isSecret: false, group: 'auth' },
  ...
  { key: 'CDS_BUG_REPORT_MAP_TOKEN', description: '快捷提缺陷转发到 MAP 的服务端 Token（推荐改由 CDS 系统设置托管）', isSecret: true, group: 'misc' },
  { key: 'CDS_BUG_REPORT_MAP_ASSIGNEE', description: '快捷提缺陷的默认 MAP 指派用户 ID', isSecret: false, group: 'misc' },
