      ...
      content={
        loading ? (
          ...
          <div className="h-full min-h-0 grid gap-3 md:grid-cols-2">
            <div className="rounded-[16px] p-3 overflow-hidden flex flex-col min-h-0" style={{ border: '1px solid var(--border-subtle)', background: 'var(--nested-block-bg)' }}>
              ...
              <div className="mt-2 grid gap-2" style={{ gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)' }}>
                {[
                  ...
                  <div
                    ...
                    style={{ border: '1px solid var(--border-subtle)', background: 'var(--nested-block-bg)', minWidth: 0 }}
                    title={String(row.v ?? '')}
                  >
              ...
              <div className="mt-2 flex-1 min-h-0 overflow-auto">
                ...
                >
                  <div className="prd-md">
                    ...
                    >
                      {unwrapMarkdownFences(answerText) || (detail.status === 'running' ? '（生成中…）' : '（无输出）')}
                    </ReactMarkdown>
                  </div>
                </div>
              </div>
