...
const phaseConfig: Record<SsePhase, { color: string; bg: string; border: string }> = {
  ...
  connecting: { color: 'var(--accent-fg-blue)', bg: 'rgba(120,180,255,0.08)', border: 'rgba(120,180,255,0.2)' },
  streaming: { color: 'var(--accent-fg-blue)', bg: 'rgba(120,180,255,0.08)', border: 'rgba(120,180,255,0.2)' },
  done: { color: 'var(--accent-fg-success)', bg: 'rgba(120,220,180,0.08)', border: 'rgba(120,220,180,0.2)' },
  error: { color: 'var(--accent-fg-danger)', bg: 'rgba(255,100,100,0.08)', border: 'rgba(255,100,100,0.2)' },
};
