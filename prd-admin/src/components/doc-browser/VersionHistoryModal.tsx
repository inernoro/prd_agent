                  ...
                  <button
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {idx === 0 && (
                        ...
                        <span className="text-[10px] px-1.5 py-0.5 rounded" style={{ background: 'rgba(34,197,94,0.12)', color: 'var(--accent-fg-success)' }} title="最新的一条历史快照（个别写入路径不产生版本，未必等于当前在线正文）">最新</span>
                      )}
