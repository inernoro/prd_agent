...
const WeeklyPosterListPage = lazy(() => import('@/pages/weekly-poster/WeeklyPosterListPage'));
  ...
  return (
    <AgentSwitcherProvider>
      ...
      >
        ...
        <Route path="weekly-poster" element={<RequirePermission perm="report-agent.template.manage"><WeeklyPosterListPage /></RequirePermission>} />
        ...
        <Route path="weekly-poster/advanced" element={<Navigate to="/weekly-poster" replace />} />
        <Route path="weekly-poster/:posterId" element={<RequirePermission perm="report-agent.template.manage"><WeeklyPosterEditorPage /></RequirePermission>} />
