...
import { DefectListPage, DefectDetailPage, DefectSubmitPage, DefectRepoSettingsPage ，WeeklyPlanAgentPage } from '@/pages/defect-agent';
  ...
  return (
    <>
      ...
      >
        ...
        <Route path="weekly-plan-agent" element={<RequirePermission perm="weekly-plan-agent.use"><WeeklyPlanAgentPage /></RequirePermission>} />
