    ...
    >
      ...
      >
        <header className="shrink-0 px-5 py-4 border-b border-token-subtle flex items-center justify-between gap-3">
          <div>
            <h2 className="text-base font-semibold text-token-primary">识途使用帮助</h2>
            <p className="mt-1 text-xs text-token-muted">新人文化与制度问答 — 严格基于知识库回答，不杜撰。</p>
          </div>
        ...
        >
          <section className="rounded-xl border border-token-subtle bg-token-nested p-4">
            <h3 className="text-sm font-medium text-token-primary mb-2">识途是做什么的？</h3>
          ...
          <section className="rounded-xl border border-token-subtle bg-token-nested p-4">
            <h3 className="text-sm font-medium text-token-primary mb-2">四个分类怎么用</h3>
          ...
          <section className="rounded-xl border border-token-subtle bg-token-nested p-4">
            <h3 className="text-sm font-medium text-token-primary mb-2">问答区说明</h3>
            <ul className="list-disc list-inside space-y-1.5 text-token-secondary">
          ...
          <section className="rounded-xl border border-token-subtle bg-token-nested p-4">
            <h3 className="text-sm font-medium text-token-primary mb-2">知识库维护</h3>
            <p className="text-token-secondary leading-relaxed">
