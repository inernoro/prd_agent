...
function DeckCard({
  ...
  return (
    <div
      onClick={onOpen}
      className="group relative rounded-xl border border-token-subtle bg-token-nested hover-bg-soft/[0.06] hover:border-token-subtle transition-all cursor-pointer p-4 flex flex-col gap-3"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-0.5 text-xs text-token-muted truncate">
