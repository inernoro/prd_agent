...
// 节号配色:浅色模式下 alpha 略降,避免大块色条喧宾夺主;暗色保持原发光感
const SECTION_RGB = [
  '59, 130, 246',  // blue
  '34, 197, 94',   // green
  '168, 85, 247',  // purple
...
function buildSectionThemes(theme: DataTheme) {
  const isLight = theme === 'light';
  const bgAlpha = isLight ? 0.04 : 0.06;
  const borderAlpha = isLight ? 0.18 : 0.15;
      ...
      {report.autoGeneratedAt && (
        <div
          ...
          style={{
            ...
            border: `1px solid ${isLight ? 'rgba(168, 85, 247, 0.18)' : 'rgba(168, 85, 247, 0.12)'}`,
          }}
        >
          <Sparkles size={14} />
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-1.5">
                      ...
                      {section.templateSection.isRequired && (
                        <span className="text-[11px] px-1.5 py-0.5 rounded" style={{ color: 'rgba(239, 68, 68, 0.8)', background: isLight ? 'rgba(239, 68, 68, 0.08)' : 'rgba(239, 68, 68, 0.06)', border: isLight ? '1px solid rgba(239, 68, 68, 0.18)' : 'none' }}>
                          必填
                        </span>
                      )}
                    </div>
