    ...
    <div className="flex flex-col gap-4 h-full min-h-0">
      ...
      {report.autoGeneratedAt && (
        <GlassCard className="px-4 py-2">
          <div className="flex items-center gap-2 text-[12px]" style={{ color: 'rgba(168, 85, 247, 0.9)' }}>
            <Sparkles size={12} />
                ...
                {(sections[sIdx]?.items || []).map((item, iIdx) => (
                  <div key={iIdx} className="flex items-start gap-2">
                    ...
                    {item.source && item.source !== 'manual' && (
                      <span
                        className="text-[9px] px-1.5 py-0.5 rounded self-center"
                        style={{
                          color: item.source === 'ai' ? 'rgba(168, 85, 247, 0.9)' : 'rgba(59, 130, 246, 0.9)',
                          background: item.source === 'ai' ? 'rgba(168, 85, 247, 0.1)' : 'rgba(59, 130, 246, 0.1)',
                        }}
                      >
