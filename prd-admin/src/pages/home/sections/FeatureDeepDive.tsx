...
function MockupFrame({
  ...
  return (
    <div
      className="relative rounded-2xl overflow-hidden border border-token-subtle bg-[#0A0D14] p-5 md:p-6"
      style={{
      ...
      <div ref={gridRef} className="grid grid-cols-2 gap-2">
        {grads.map((g, i) => {
          ...
          return (
            <div
              key={i}
              className="relative aspect-[4/3] rounded-lg overflow-hidden border border-token-subtle/[0.06]"
              style={{
                background: g,
                opacity: inView ? 1 : 0,
                transform: inView
...
function LiteraryMockup() {
  ...
  return (
    <MockupFrame accent={accent}>
      ...
      <div className="mt-5 pt-4 border-t border-token-subtle flex items-center justify-between text-[10px] text-white/45">
...
function VideoMockup() {
  ...
  return (
    <MockupFrame accent={accent}>
      ...
      <div className="relative h-1 bg-token-nested rounded-full overflow-hidden">
        <div
    ...
    <MockupFrame accent={accent}>
      ...
      <div className="space-y-2.5">
        {t.mockups.defect.items.map((d, i) => (
          <div
            key={i}
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-white/[0.03] border border-token-subtle"
          >
            <div
