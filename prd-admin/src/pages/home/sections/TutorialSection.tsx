...
const tutorials = [
  {
    ...
    title: 'PRD Agent',
    subtitle: '智能需求文档解读',
    description: '「PRD 对话」Tab 智能问答 +「群组管理」Tab 协作审阅，支持内容缺失检测和测试用例生成。',
    ...
    steps: [
      { title: '创建群组', desc: '群组管理 Tab → 邀请成员协作' },
      { title: '上传文档', desc: '支持 PDF、Word、Markdown' },
      { title: '智能问答', desc: 'PRD 对话 Tab 精准回答' },
    ],
  ...
  },
  {
    ...
    description: '三栏式工作区：左侧工具面板、中间无限画布、右侧 AI 对话。尺寸标签如「1K·1:1」一目了然。',
    ...
    steps: [
      { title: '新建工作区', desc: '进入三栏式创作界面' },
      { title: '对话生图', desc: '右侧聊天区描述画面' },
      { title: '画布编辑', desc: '拖拽到画布精细编辑' },
    ],
  ...
  },
  {
    ...
    title: '文学创作 Agent',
    subtitle: '智能配图与文学润色',
    description: '点击「新建文章」创建作品，「选择文件」上传文本，AI 为每段生成「配图 N」卡片，支持 20+ 风格。',
    ...
    steps: [
      { title: '新建文章', desc: '点击「新建文章」按钮' },
      { title: '导入内容', desc: '「选择文件」上传或粘贴' },
      { title: '生成配图', desc: 'AI 生成「配图 N」卡片' },
    ],
  ...
  },
  {
    ...
    title: '缺陷管理 Agent',
    subtitle: 'AI 驱动的缺陷管理',
    description: '「收到的」「我提交的」双 Tab + 4 种视图（列表/网格/看板/统计），顶部快捷入口一键操作。',
    ...
    steps: [
      { title: '创建项目', desc: '点击「项目管理」按钮' },
      { title: '提交缺陷', desc: '「提交缺陷」按钮，AI 分类' },
      { title: '跟踪处理', desc: '看板拖拽 + 分享协作' },
    ],
  ...
  },
  {
    ...
    title: '视频创作 Agent',
    subtitle: '文章一键转视频',
    description: '「生成分镜标记」拆分为「镜头 N」卡片（8 种场景），三阶段进度条追踪，「导出视频」下载 MP4。',
    ...
    steps: [
      { title: '上传文章', desc: '粘贴内容，点击「生成分镜标记」' },
      { title: '编辑分镜', desc: '调整「镜头 N」，选场景类型' },
      { title: '导出视频', desc: '支持 MP4/SRT/台词下载' },
    ],
  ...
  },
  {
    ...
    title: '周报管理 Agent',
    subtitle: 'AI 辅助周报生成',
    description: '「周报」「团队」「设置」三 Tab，集成 Git 数据源自动拉取 commit，AI 一键生成结构化周报。',
    ...
    steps: [
      { title: '配置数据源', desc: '设置 Tab → 添加 Git 仓库' },
      { title: '记录日志', desc: '周报 Tab → 每日记录' },
      { title: 'AI 生成', desc: '一键输出完成/进行中/计划/风险' },
    ],
  ...
  },
  {
    ...
    title: 'AI 竞技场',
    subtitle: '多模型盲测对比',
    description: '匿名标记「助手 A」「助手 B」同时回答，实时显示 TTFT 和思考过程，点击「Reveal」揭晓身份。',
    ...
    borderColor: 'border-amber-500/20',
    steps: [
      { title: '创建竞技组', desc: '选择 2-4 个模型，身份打乱' },
      { title: '发起对战', desc: '所有模型同时流式回答' },
      { title: '评判揭晓', desc: '点击「Reveal」揭晓身份' },
    ],
  ...
  },
  {
    ...
    title: '工作流引擎',
    subtitle: '可视化流程编排',
    description: '画布编辑器拖拽 5 种胶囊节点（HTTP/延时/条件/转换/通知），执行日志按颜色区分，支持 Artifact 预览。',
    ...
    steps: [
      { title: '创建工作流', desc: '输入名称，进入画布编辑器' },
      { title: '编排节点', desc: '拖拽 5 种胶囊并连线' },
      { title: '测试运行', desc: '查看执行日志和 Artifact' },
    ],
  ...
  },
  {
    ...
    description: '三种绑定：「仅收藏」书签、「工作流」自动化、「智能体」AI 对话。扫码安装，Siri 语音触发。',
    ...
    steps: [
      ...
      { title: '扫码安装', desc: '系统生成二维码，iPhone 扫码' },
      { title: '多种触发', desc: '桌面图标/Siri 语音/App 内' },
    ],
