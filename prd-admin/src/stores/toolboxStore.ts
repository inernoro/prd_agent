...
export const BUILTIN_TOOLS: ToolboxItem[] = [
  ...
  {
    id: 'builtin-visual-storyboard',
    name: '视觉分镜台',
    description: '一句话或一篇文章拆成电影分镜，关键帧实时生长、逐镜精修，预留 image-to-video',
    icon: 'Clapperboard',
    category: 'builtin',
    type: 'builtin',
    kind: 'agent',
    agentKey: 'visual-storyboard',
    routePath: '/visual-storyboard',
    permission: 'visual-agent.use',
    tags: ['视频', '分镜', '关键帧', '故事板', 'storyboard', '智能体'],
    usageCount: 0,
    createdAt: new Date().toISOString(),
    wip: true,
  },
  ...
  },
  {
    ...
    type: 'builtin',
    kind: 'agent',
    agentKey: 'front-end-agent',
    routePath: '/front-end-agent',
    permission: 'front-end-agent.use',
    tags: ['前端', 'API', '组件', '报错', 'CSS'],
    usageCount: 0,
    createdAt: new Date().toISOString(),
    wip: true,
  },
  {
    id: 'builtin-tapd-bug-agent',
    name: 'TAPD 缺陷自动提报',
    description: '把口语描述整理为标准四要素，确认后创建 TAPD 缺陷',
    icon: 'Bug',
    category: 'builtin',
    type: 'builtin',
    kind: 'tool',
    agentKey: 'tapd-bug-agent',
    routePath: '/tapd-bug-agent',
  ...
  {
    id: 'builtin-mcp-console',
    name: '智能体接入台',
    description: '把平台接进你自己的智能体：授权哪些能力、连着哪几台客户端、它们刚才做了什么',
    icon: 'Plug',
    category: 'builtin',
    type: 'builtin',
    kind: 'tool',
    agentKey: 'mcp-console',
    routePath: '/mcp-console',
    permission: 'access',
  ...
  },
  {
    ...
    name: '短视频解析',
    description: '在知识库内把抖音/TikTok 等短视频链接解析成原始素材、字幕文稿和时间轴片段',
    icon: 'Video',
    category: 'builtin',
    type: 'builtin',
    kind: 'tool',
