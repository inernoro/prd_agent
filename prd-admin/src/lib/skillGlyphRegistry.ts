...
export type GlyphShape = 'compass' | 'botanical' | 'astro';

export interface GlyphStyle {
  shape: GlyphShape;
  /** 暖色相基准（度）。三组 tag 落在不同暖区，肉眼可分辨「系列」 */
  hueBase: number;
}
