...
export const api = {
  ...
  defectAgent: {
    ...
    defects: {
      ...
      verifyFail: (id: string) => `/api/defect-agent/defects/${id}/verify-fail`,
    ...
    statsOverview: () => '/api/defect-agent/stats/overview',
    statsTrend: () => '/api/defect-agent/stats/trend',
    statsByUser: () => '/api/defect-agent/stats/by-user',
    users: () => '/api/defect-agent/users',
    polish: () => '/api/defect-agent/defects/polish',
    analyzeImage: () => '/api/defect-agent/images/analyze',
    projects: {
      list: () => '/api/defect-agent/projects',
      byId: (id: string) => `/api/defect-agent/projects/${id}`,
    },
    teams: () => '/api/defect-agent/teams',
    webhooks: {
      list: () => '/api/defect-agent/webhooks',
      byId: (id: string) => `/api/defect-agent/webhooks/${id}`,
    },
    logs: {
  ...
  zhunxing: {
    ...
    documentsExpireNow: () => '/api/zhunxing/documents/expire-now',
    documentDiff: () => '/api/zhunxing/documents/diff',
    document: (documentId: string) => `/api/zhunxing/documents/${documentId}`,
    documentTimeline: (documentId: string) => `/api/zhunxing/documents/${documentId}/timeline`,
    clauses: () => '/api/zhunxing/clauses',
    categories: () => '/api/zhunxing/categories',
    tags: () => '/api/zhunxing/tags',
    ...
    subscriptionMe: () => '/api/zhunxing/subscriptions/me',
    subscriptionUpdates: () => '/api/zhunxing/subscriptions/me/updates',
    heatmap: () => '/api/zhunxing/heatmap',
  },
