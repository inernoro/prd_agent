...
public static class AdminPermissionCatalog
{
    ...
    /// <summary>
    /// 网页托管高级权限：查看「全部用户」的托管站点及其阅读量与访客记录（跨用户审计视图）
    /// </summary>
    public const string WebPagesViewAll = "web-pages.viewAll";
    ...
    /// <summary>
    /// 个人任务树-全员卡点查看：在卡点墙聚合查看所有人的卡点（管理层/上级用，普通成员只看自己）
    /// </summary>
    public const string TaskTreeViewAll = "task-tree.view-all";
    ...
    public static readonly IReadOnlyList<AdminPermissionDef> All = new List<AdminPermissionDef>
    {
        ...
        new(PmAgentUse, "项目管理", "项目立项、任务看板、甘特图与 AI 需求拆解"),
        ...
        new(ProductAgentUse, "产品管理", "产品-版本-需求-功能-缺陷-客户全链路串联、知识图谱、知识库挂载"),
