...
public static class ProductImportProductRouting
{
    ...
    /// <summary>
    /// 从标题【】、来源字段（含「应用」）或版本行解析标签，再匹配产品 Name/Code；
    /// 无匹配时返回 fallbackProductId。
    /// </summary>
        ...
        string? fallbackProductId)
    {
        ...
        return ResolveProductIdByLabel(products, label, fallbackProductId);
    }
