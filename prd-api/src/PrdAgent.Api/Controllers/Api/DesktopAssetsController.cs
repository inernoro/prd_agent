...
/// </summary>
[ApiController]
[Route("api/assets/desktop")]
[Authorize]
[AdminController("assets", AdminPermissionCatalog.AssetsRead, WritePermission = AdminPermissionCatalog.AssetsWrite)]
public class DesktopAssetsController : ControllerBase
{
    private readonly MongoDbContext _db;
    private readonly ILogger<DesktopAssetsController> _logger;
    ...
    public DesktopAssetsController(MongoDbContext db, ILogger<DesktopAssetsController> logger, IAssetStorage assetStorage)
    {
        _db = db;
        _logger = logger;
