...
/// </summary>
[ApiController]
[Route("api/mds/scheduler-config")]
[Authorize]
...
public class SchedulerConfigController : ControllerBase
{
    ...
    private readonly ILogger<SchedulerConfigController> _logger;

    public SchedulerConfigController(MongoDbContext db, ILogger<SchedulerConfigController> logger)
    {
        _db = db;
        _logger = logger;
    }
