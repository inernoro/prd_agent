...
[Route("api/groups")]
[Authorize]
[AdminController("groups", AdminPermissionCatalog.GroupsRead, WritePermission = AdminPermissionCatalog.GroupsWrite)]
public class GroupsController : ControllerBase
{
    ...
    public GroupsController(MongoDbContext db, ICacheManager cache, ILogger<GroupsController> logger)
    {
        _db = db;
        _cache = cache;
        _logger = logger;
