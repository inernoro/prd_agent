...
/// </summary>
[ApiController]
[Route("api/assets/avatars")]
[Authorize]
[AdminController("assets", AdminPermissionCatalog.AssetsRead, WritePermission = AdminPermissionCatalog.AssetsWrite)]
public class AvatarAssetsController : ControllerBase
{
    private readonly ILogger<AvatarAssetsController> _logger;
    private readonly IAssetStorage _assetStorage;

    private const long MaxUploadBytes = 5 * 1024 * 1024; // 5MB：头像应很小

    public AvatarAssetsController(ILogger<AvatarAssetsController> logger, IAssetStorage assetStorage)
    {
        _logger = logger;
