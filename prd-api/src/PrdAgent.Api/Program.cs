...
// Apple Shortcuts URL 解析服务
builder.Services.AddHttpClient("UrlParser", client =>
{
    client.Timeout = TimeSpan.FromSeconds(15);
    client.DefaultRequestHeaders.Add("Accept", "text/html,application/xhtml+xml");
});
builder.Services.AddScoped<PrdAgent.Core.Interfaces.IUrlParserService, PrdAgent.Infrastructure.Services.UrlParserService>();
