...
public class MongoDbContext
{
    ...
    public IMongoCollection<DocumentRecordingUploadSession> DocumentRecordingUploadSessions => _database.GetCollection<DocumentRecordingUploadSession>("document_recording_upload_sessions");
    public IMongoCollection<DocumentRecordingUploadChunk> DocumentRecordingUploadChunks => _database.GetCollection<DocumentRecordingUploadChunk>("document_recording_upload_chunks");
    public IMongoCollection<DocumentStoreConversation> DocumentStoreConversations => _database.GetCollection<DocumentStoreConversation>("document_store_conversations");
