...
public sealed class LlmRequestLogBackground
{
    ...
    private async Task UpdateDoneAsync(string logId, LlmLogDone done)
    {
        ...
        var update = Builders<LlmRequestLog>.Update
            ...
            .Set(l => l.EstimatedCacheReadCost, done.EstimatedCacheReadCost)
            .Set(l => l.EstimatedCacheWriteCost, done.EstimatedCacheWriteCost)
            ...
            .Set(l => l.CostStatus, done.CostStatus)
            .Set(l => l.CostUnpricedReason, done.CostUnpricedReason)
