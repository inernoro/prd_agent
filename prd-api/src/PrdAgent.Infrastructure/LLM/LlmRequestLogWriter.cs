    ...
    public async Task<string?> StartAsync(LlmLogStart start, CancellationToken ct = default)
    {
        try
        {
            ...
            var log = new LlmRequestLog
            {
                ...
                Model = start.Model,
                LogicalModelId = start.LogicalModelId,
                LogicalModelPublicId = start.LogicalModelPublicId,
                OfferingId = start.OfferingId,
                OfferingTargetKind = start.OfferingTargetKind,
