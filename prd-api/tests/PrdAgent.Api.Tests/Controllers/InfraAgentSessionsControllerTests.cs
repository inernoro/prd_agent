...
public class InfraAgentSessionsControllerTests
{
    ...
    public async Task RuntimeStatus_ShouldExposeDefaultRuntimeProfileCompatibility()
    {
        ...
        try
        {
            ...
            executionPanel.TaskBoard.Count.ShouldBe(11);
            ...
            executionPanel.TaskBoard.Single(x => x.Code == "R0.6").Status.ShouldBe("active");
            executionPanel.TaskBoard.Single(x => x.Code == "R0.6").NextAction.ShouldContain("official SDK runtime capacity");
            executionPanel.NextStepEta.ShouldContain("R0.6");
