...
public class InfraAgentSessionsControllerTests
{
    ...
    public async Task RuntimeStatus_ShouldExposeDefaultRuntimeProfileCompatibility()
    {
        ...
        try
        {
            ...
            debugCommands.Single(x => x.Code == "r1-apply").BlockedBy.ShouldBe("CDS-managed provider-switch profile/secret");
    ...
    public async Task RuntimeStatus_ShouldExposeCommercialReadinessLedger()
    {
        ...
        try
        {
            ...
            executionPanel.NextCommand.ShouldBe("CDS_HOST=<configure-CDS_AGENT_SMOKE_CDS_HOST> bash scripts/smoke-cds-agent-r1-profile-repair.sh");
