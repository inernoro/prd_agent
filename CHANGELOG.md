...
| fix | prd-admin | 百宝箱卡片缩小至原来 1/3~1/4 大小，grid 改用 auto-fill + minmax(140px) 使列数随屏幕宽度自适应；修复 Spotlight 边框溢出；补全 arena/shortcuts/workflow 封面图映射；自定义工具卡片底栏显示作者头像+名字+使用次数 |
