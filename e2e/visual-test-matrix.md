...
| V-04 | 验证构建中卡片有显眼耗时 | 找到构建中/启动中分支卡片，检查 `.branch-build-elapsed` | 卡片 chip 显示“构建 00:xx”或“启动 00:xx”，并逐秒更新 | ✅ 通过：Playwright fixture 注入构建中分支，卡片显示 `.branch-build-elapsed` 且计时文本会变化 |
