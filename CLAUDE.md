...
| 周报管理 Agent | ✅ DONE | ReportAgentController, ReportAgentPage (4 tabs: 我的周报/团队面板/模板管理/团队管理) |
...
周报管理：`report_teams`, `report_team_members`, `report_templates`, `report_weekly_reports`
