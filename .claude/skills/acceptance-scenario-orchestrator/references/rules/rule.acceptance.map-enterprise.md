...
contentHash: sha256:499e03d4b9039163460588de6ed92abb796d37a1770498b5d64ad9d4cb6b3474
...
> **用词（2026-09-09 转正）**：`conditional` 的中文一律写「原则性通过」，不再写「有条件通过」。
> 枚举值 `conditional` 不变，改的只是给人读的那个词。归档门禁两种写法都接受，
> 存量报告与在途报告不因此被拒收；历史周报与 CHANGELOG 保留当时的原话，不回溯改写。
