...
sourceCommit: 100c922ec78b7018a3ee6f25ebde037cba4e5598+worktree
contentHash: sha256:1ee169e0bf7680c2f07c3571dc0ef52fdfc9cbe1ce4e4a7a7f9c3b9742a80bad
...
| 字段 | 回答的问题 |
|---|---|
| 产品质量 | 是否发现可复现的产品缺陷；缺陷数量和最高严重级是什么；必须写 `核心用例=通过/失败/未执行`；未执行时验收完整性必须为不完整 |
