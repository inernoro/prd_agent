...
> **版本**：v1.0.0 | **状态**：已落地 | **触发**：`/issues-visual-run`、"执行视觉验收"、"视觉测试接单"、"visual test run" | **SSOT**：`doc/rule.skill.issues-system.md`
...
>
> 协议本体与 label 体系见 `doc/rule.skill.issues-system.md`。模板演化讨论在 #605。
