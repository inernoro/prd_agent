...
> **版本**：v1.8.0 | **状态**：已落地 | **触发**：「修复缺陷」、「缺陷自动修复」、`ai-defect-resolve` | **SSOT**：`doc/design.defect-automation-autonomy.md`
...
> SSOT：`doc/design.defect-automation-autonomy.md`。本技能不是线性脚本，是一个有边界、能担责的自治体系。下面的判断先于、并贯穿上面的流程步骤。判定口诀：动手前先问「这条该不该我全权改，还是该停下问人」。
