...
def _static_checks() -> list[dict]:
    ...
    ok, detail = _contains_all(
        ...
        [
            ...
            "LLMGW_EXTERNAL_BACKUP_MONGO_CONTAINER",
            ...
            "mongodump --db '$db'$collection_arg --archive",
    ...
    ok, detail = _contains_all(
        ...
        [
            ...
            "gatewayDb.llmgw_platforms",
            "gatewayDb.llmgw_model_exchanges",
            "gatewayDb.llmgw_model_pools",
            "gatewayDb.llmgw_app_callers",
            "llmrequestlogs",
            ...
            "requiredPairs",
            "missingPairs",
            "deferredUnboundGroups",
            "unbound-to-production-appCaller",
            "unboundPoolLeakedAsBlocker",
            "asrClassifications",
            "asrDiagnostic",
