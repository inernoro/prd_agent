...
# 刷新 doc/design.cds.agent.commercial-architecture-and-roadmap.md。
...
STATUS_DOC="${CDS_AGENT_RUNTIME_POOL_STATUS_DOC:-$ROOT_DIR/doc/design.cds.agent.commercial-architecture-and-roadmap.md}"
