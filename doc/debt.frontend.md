...
| 51 本书里只有 1 本填了 `relatedRules` | 精读稿第三段「我们在哪儿栽过」是它唯一不可替代的部分（书摘网上到处都是）。没填关联规则的书，那一段只会写「这本书还没有对上我们自己的事故记录」——稿子退化成一篇普通书摘 | 待办：逐本挑规则。硬凑不相干的比留空更糟（读者会照着去翻然后发现对不上），所以只填真对得上的。守卫已钉住「填的规则必须真实存在」与「至少一条带真实故事」 |
