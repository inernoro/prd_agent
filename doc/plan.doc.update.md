...
| 4 | `4.dev.md` | 开发指南 | P0 |
| 5 | `5.step.md` | 步骤指南 | P1 |
| 6 | `design.platform.ops-auth.md` | 运维认证更新器 | P1 |
| 7 | `rule.platform.data-dictionary.md` | 数据字典 | P0 |
...
| 14 | `design.frontend.toast.md` | Toast通知系统 | 待评估 |
| 17 | `design.frontend.left-right-layout.md` | 左右布局重设计 | 待评估 |

### 2.3 原非编号文档（已编号，待清理评估）

| 文件名 | 说明 | 初步判断 |
|--------|------|----------|
| `design.platform.network-diagnostics.md` | 网络诊断 | 待评估 |
...
- [ ] `3.prd.md` - 更新产品需求
- [ ] `4.dev.md` - 更新开发指南
- [ ] `rule.platform.data-dictionary.md` - 更新数据字典
...
| rule.platform.data-dictionary.md | 新数据模型(91个)、新字段 | P0 |
...
6. ~~执行阶段六：文档更新~~ ✅
   ...
   - [x] 更新 rule.platform.data-dictionary.md（新增16个MongoDB集合、桌面端新增store）
...
| 文件名 | 保留原因 |
|--------|----------|
| `design.platform.network-diagnostics.md` | 桌面端网络诊断功能文档 |
