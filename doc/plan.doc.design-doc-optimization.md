...
### P1 — 核心模块新文档
- [x] `design.emergence.system.md` — 涌现篇（系统灵魂说明书）
...
### P2 — 基础设施 + 深化
- [x] `design.platform.rbac-permission.md` — 权限系统设计
- [x] `design.platform.llm-gateway.md` — LLM Gateway 架构
- [x] `design.marketplace.md` — 配置市场设计
- [x] `design.workflow-agent.engine.md` — 深化（+管理摘要 +4 场景）
