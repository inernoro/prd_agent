# 2026-W12 (2026-03-16 ~ 2026-03-22) · 周报

> **版本**：v1.0 | **日期**：2026-03-16 | **状态**：已落地
...
| W11 建议方向 | W12 实际进展 |
|--------------|-------------|
| P0 知识库 RAG 集成 | 警告 PR #275 实现多格式文件支持 (PDF/Word/Excel/PPT)，但向量索引和对话引用仍未推进 |
| P0 CDS 实际使用验证 | 是 14 个 PR 深度验证并大幅增强：自动更新、活动监控、SSE 日志流、部署流水线、容器状态推送 |
| P1 周报 Agent Phase 1 | 是 超额完成：团队汇总视图、AI 可配生成、打回机制、富文本编辑、点赞评论完整闭环 |
| P1 Apple Shortcuts Phase 2 | 警告 PR #291 实现从快捷指令自动提取视频 URL，但 Agent 绑定和收藏管理未推进 |
| P2 缺陷管理 Webhook | 否 Webhook 对接未推进，但缺陷管理获得 AI 评分流式化和外部 Agent 协作能力 |
| P2 移动端系统性 QA | 警告 PR #272 批量修复 Safari 6 类兼容性问题，但尚未进行系统性移动端测试 |
...
| PR | 标题 | 分类 |
|----|------|------|
| #238 | 周报整理与 W11 周报生成 | 文档 文档 |
| #239 | 周报功能完整操作指南 | 文档 文档 |
| #240 | CDS 端口冲突修复 (仅杀 CDS 进程) | 修复 修复 |
| #241 | 禁用账号友好错误提示 | 修复 修复 |
| #242 | LLM 日志补全 UserId 和上下文字段 | 修复 修复 |
| #243 | 配图标记批量修改尺寸 + 尺寸持久化 | 新功能 新功能 |
| #244 | 缺陷管理桌面端卡片+列表双视图 | 新功能 新功能 |
| #245 | 4 个文档技能安装与评测报告 | 文档 文档 |
| #246 | 周报两个 Bug 修复 | 修复 修复 |
| #247 | 群组管理 — 解散/退出/成员/系统消息 | 新功能 新功能 |
| #250 | 周报周视图重设计，聚焦周报浏览 | 更新 更新 |
| #252 | CDS 导出部署技能 + 调度/执行分离架构 | 新功能 新功能 |
| #253 | 周报团队页重构 + 富文本 + 点赞 + 打回 | 新功能 新功能 |
| #254 | 工作流画布 6 项编辑器功能集成 | 新功能 新功能 |
| #255 | CDS 终端 Tab 容器内命令执行 | 新功能 新功能 |
| #256 | 图片尺寸适配优先同档位匹配 | 修复 修复 |
| #258 | 系统日志筛选 UI + UserSearchSelect 公共组件 | 更新 更新 |
| #259 | 周报 AI 生成 + 数据源 + Prompt 配置 | 新功能 新功能 |
| #260 | CDS 状态栏移除 + 亮色模式切换 | 更新 更新 |
| #261 | 首页 + 侧栏导航全面重设计 | 界面 UI/UX |
| #262 | 缺陷分享外部 Agent 分析 + 开放平台认证 | 新功能 新功能 |
| #263 | 桌面端静默更新 + 动态域名配置 | 新功能 新功能 |
| #264 | 缺陷列表单行紧凑布局 + 图片缩略图 | 界面 UI/UX |
| #265 | CDS 亮色主题 + 容量检查 + 水波纹动效 | 新功能 新功能 |
| #266 | Favicon 修复 + 侧栏导航圆角矩形统一 | 修复 修复 |
| #267 | CDS 启动信号 + 孤儿分支清理 + 部署日志 | 新功能 新功能 |
| #268 | SSE 延迟优化 650→100ms + 乐观 UI 动画 |  性能 |
| #269 | 需求验证技能 (/validate) | 新功能 新功能 |
| #270 | 桌面更新 COS 加速 + 3s 超时回退 GitHub |  性能 |
| #271 | 预览地址技能 (/preview) | 新功能 新功能 |
| #272 | Safari 6 类 CSS 兼容性批量修复 | 修复 修复 |
| #273 | 桌面端主题切换 View Transition 水波纹 | 界面 UI/UX |
| #274 | Changelog Fragments 机制消除合并冲突 | 架构 架构 |
| #275 | 自定义智能体多格式文件支持 (PDF/Word/Excel/PPT) | 新功能 新功能 |
| #276 | 工作流创建后自动跳转画布 | 更新 更新 |
| #277 | 模型池自动探活 + 故障通知到用户 | 新功能 新功能 |
| #278 | 百宝箱卡片自适应 + 封面图补全 | 修复 修复 |
| #279 | 日志补充用户信息字段 | 更新 更新 |
| #280 | CDS 自动更新小组件 (proxy 注入 + combobox) | 新功能 新功能 |
| #281 | AppCallerCode 注册强制校验 + 启动同步 | 修复 修复 |
| #282 | CDS 分支彩色标记 + Widget API 修复 | 新功能 新功能 |
| #283 | 缺陷管理权限校验 + 严重程度编辑修复 | 修复 修复 |
| #284 | 缺陷 AI 评分 SSE 流式 + SSE 基础组件库 | 新功能 新功能 |
| #285 | CDS 分支名 slug 解析修复 | 修复 修复 |
| #286 | 统一技能系统迁移 + SKILL.md 导入导出 | 架构 架构 |
| #287 | 用户列表表格布局 + 统计信息列 | 新功能 新功能 |
| #288 | 周报完整操作指南重写 | 文档 文档 |
| #289 | 模型实验室 API URL 相对路径修复 | 修复 修复 |
| #290 | CDS 502 间歇错误 + 主题切换皮肤修复 | 修复 修复 |
| #291 | CDS AI 部署流水线技能 + API 活动监控 | 新功能 新功能 |
| #292 | Agent 卡片悬停视频自动播放 | 新功能 新功能 |
| #293 | CDS 活动监控面板 + 容器状态推送 + SSE 日志 | 新功能 新功能 |
| #294 | Web PRD Agent 桌面化布局 + 预览对齐 | 新功能 新功能 |
| #295 | CDS 系统状态接口描述修正 | 修复 修复 |
| #296 | CDS SSE 心跳防 524 + 分支来源显示 | 修复 修复 |
| #297 | 自定义智能体工具箱完整聊天闭环 (20+ 功能) | 新功能 新功能 |
| #298 | 用户角色扩展 8 个新角色 + 涟漪审计规则 | 新功能 新功能 |
| #299 | 作品广场完整投稿展示系统 | 新功能 新功能 |
| #300 | 教程中心 + 9 个 Agent 教程 + /tutorials 路由 | 新功能 新功能 |
| #301 | 心型点赞按钮动画修复 | 修复 修复 |
| #302 | CI TypeScript 编译错误修复 | 修复 修复 |
| #303 | 文学创作仅展示当前版本配图 | 修复 修复 |
| #305 | 默认路由逻辑修复 (未登录→首页/退出→登录) | 修复 修复 |
| #306 | 图片预览层级修复 + 用户一键过期功能 | 新功能 新功能 |
| #307 | 水印预览 COS URL + 评论 Markdown + 5 项修复 | 修复 修复 |
| #308 | CI 测试断言修复 (Trivial 严重等级) | 修复 修复 |
| #309 | 作品广场独立全屏页面 | 新功能 新功能 |
| #310 | 排行榜维度精简 + 产出指标 + 缺陷严重等级 | 更新 更新 |
