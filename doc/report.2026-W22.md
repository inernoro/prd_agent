...
- **CDS 教程体系（#696）**
  ...
  - 教程指南 [doc/guide.cds.tutorial.md](./guide.cds.tutorial.md) + 知识库发布脚本
...
- **cdscli verify 评分 / 自愈（#696）**
  ...
  - 规则 SSOT：[doc/spec.cds.compose-contract.md](./spec.cds.compose-contract.md) §4.4/§4.5
...
- **日常熵减计划（main 上 chore commits）**：
  - 5-27 日常熵清理（含 spec.product-agent.pa.savage-iter-v2 索引补齐）
  - 5-28 每日熵减计划
  - 5-29 每日熵减计划
...
|------------------------------|--------------|
| P0 分享链接安全加固真人 UAT 回归 | 警告 部分落地。短链密码风险弹窗（#671）补齐，但"分享链接体检实验室"全用例真人回归未单独立项，下周仍需排期。 |
| P0 CDS Agent 官方 SDK 接 1 个真实外部工程 | 否 未落地。本周走向是 #693 Lite 降级绕开 R1，没有接外部 Anthropic Agent SDK 工程；建议下周明确"先 Lite 上线 vs 必须接外部"路线。 |
| P1 周报编辑器大改造真人验收 + 移动端适配 | 警告 未单独立项。W21 编辑器交付后本周未做移动端适配，但 #696 知识库卡片改版顺手改善了周报相关展示。 |
| P1 知识库单一数据源回归测试 | 是 落地。#666/#678 修复再加工后台化与进度卡死，#692 验收报告知识库三项改进；W23 #709 进一步根治订阅 540 条空白条目。 |
| P2 CDS 日志 Mongo 后端容量与清理策略 | 否 未落地。日志保留期 / 自动清理仍未排期。 |
| P2 五平台博主订阅运营回归（W19 起遗留） | 否 未落地。已连续三周未推进，下周需明确"砍掉 / 排期 / 转给其他人"三选一。 |
