...
| R0.7 | CDS-managed runtime live apply | next | CDS runtime/container/sandbox start/recover + live evidence | shared-service official SDK runtime running > 0；R0 变为 pass |
