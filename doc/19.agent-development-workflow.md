...
│  ├─ 5.2 更新 SRS (2.srs.md)                                     │
│  ├─ 5.3 更新数据字典 (7.data-dictionary.md)                      │
│  ├─ 5.4 更新命名规范 (12.app-feature-naming-convention.md)        │
...
| `doc/2.srs.md` | 功能模块描述 |
| `doc/7.data-dictionary.md` | 新增集合定义 |
| `doc/12.app-feature-naming-convention.md` | 新增应用清单 |
