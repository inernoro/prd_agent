...
> **版本**：v2.0 | **日期**：2024-12-10 | **状态**：已落地

**一句话**：产品全貌：AI 替产品经理把方案讲给研发和测试听，本文写清对话、预览、权限、模型等各模块做成什么样。
**谁该读**：产品经理、新来的工程师、想知道系统整体有哪些功能的任何人。
**读完能做什么**：说清楚这个产品有哪些模块、各自解决什么问题，并判断新需求属于哪个模块。
