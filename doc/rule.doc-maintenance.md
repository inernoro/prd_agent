...
- 新增 `doc/agent.literary-agent.md`，完整描述文章配图功能的设计理念、工作流、数据模型、接口设计、前后端实现、验收标准、未来优化方向。
...
- 对于已落地的功能，创建独立的设计文档（如 `doc/agent.literary-agent.md`），避免在 SRS/PRD 中堆叠过多实现细节。
