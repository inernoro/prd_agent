...
| 项 | 开发完成 | 冒烟测试完成 | 视觉测试完成 | 说明 |
|----|----------|--------------|--------------|------|
| P11.1 新增对话页路由与导航 | [x] | [x] | [ ] | `/cds-agent` 已接入路由、设置入口和百宝箱内置智能体入口；百宝箱入口增加强制跳转兜底，待部署后从真实导航视觉验收 |
...
| P11.6 空状态与错误态 | [ ] | [x] | [ ] | 已补充模型配置引导、长期系统级授权说明和 lastError 展示；待真实入口视觉验收 |
...
| 10 | 新增 CDS Agent 对话页 | P11 | [ ] | 路由、设置入口和百宝箱入口已实现并通过本地冒烟；仍待 main 部署后的真实入口视觉验收 |
