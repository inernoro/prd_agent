...
| P16.2 事件 schema 稳定化 | [x] | [x] | [ ] | 新增 `GET /api/infra-agent-sessions/event-schema`，后端集中声明 status/text_delta/tool_call/tool_result/log/error/done/hook/file/diff/browser；待真实入口视觉 |
