...
| 2026-07-11-maintenance-release-shadow-gate | medium | 2026-07-11 | 已处于 full-http 的维护版本仍默认要求新 commit 自身拥有 24 小时 shadow；新 commit 上线前无法自然产生该证据 | full-http 后进行小版本维护发布时 | open | 拆分首次切流与维护发布 gate；维护发布继承最近成功 shadow，同时强制同 commit HTTP transport、四协议、active caller、配置权威、回滚和成功台账 |
