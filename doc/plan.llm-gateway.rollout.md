...
> **文档版本**: v1.1
> **最后更新**: 2026-06-30
> **状态**: 开发中（波1/2 已部署；波2.5 影子代码完成、已在预览真机跑通 serving resolve）
>
...
| B 协议保真 | `GatewayProtocolFidelityTests` | 91 cell + canary | think 三形态 / tool 归一 / token+cache / finish 全枚举 / 字符集 / edge→null | CI 绿 |
...
（有 quirk 时）加 ExchangeTransformer，是有界配置任务 + B 层 91-cell 测试网兜底，不是网关隔离风险。shadow 是活证据：
