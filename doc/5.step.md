...
| 密钥名称 | 说明 | 值 |
|---------|------|-----|
| `APPLE_ID` | Apple 开发者账号 | `inernoro@live.com` |
| `APPLE_PASSWORD` | App 专用密码 | `ther-dcrk-devk-ueac` |
| `APPLE_TEAM_ID` | Apple Team ID | `CP9CBWLXBZ` |
| `APPLE_CERTIFICATE` | P12 证书 Base64 编码 | *需导出并编码* |
| `APPLE_CERTIFICATE_PASSWORD` | 证书密码 | `yaBju3lPVyWT70xmQcdPFONA` |
