...
| 密钥名称 | 说明 | 值 |
|---------|------|-----|
| `APPLE_ID` | Apple 开发者账号 | `YOUR_APPLE_ID@example.com` |
| `APPLE_PASSWORD` | App 专用密码 | `YOUR_APP_SPECIFIC_PASSWORD` |
| `APPLE_TEAM_ID` | Apple Team ID | `YOUR_TEAM_ID` |
| `APPLE_CERTIFICATE` | P12 证书 Base64 编码 | *需导出并编码* |
| `APPLE_CERTIFICATE_PASSWORD` | 证书密码 | `YOUR_CERTIFICATE_PASSWORD` |
