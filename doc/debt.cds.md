...
| E86 | 低 | 2026-08-29 | **运维故意停掉的服务，连同它盘上留存的旧备份，一起从备份面板上消失**：清单只并「正在跑的」服务，停着的既不在上一轮记录里、也不在并集里 | 有服务长期停着、但盘上还留着它旧备份的项目 | **故意没做** | 这是 E85 修完之后剩下的那一半，来自 Codex 第二轮与第三轮**互相拉扯**的那条边界：第二轮要求「停着的服务也要看得见」，第三轮要求「别为故意停掉的服务报警」。两者都对，但同时满足需要再分一档（在跑却没备到 vs 停着所以没备），那是本 PR 第四个新语义类别——按 CLAUDE.md §5.5，机器 review 不能单独授权这种扩张。当前取「不报警」那一侧：宁可少说一句，不要一盏没人看的灯。代价：一台停着的库在面板上看不见，只能靠页脚「备份文件数」对不上察觉。真要做，应与 E83 / E84 一起，把「一轮备份对外怎么表述」整体重做 |
