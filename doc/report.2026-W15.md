...
| W14 建议方向              | W15 实际进展                                                     |
| --------------------- | ------------------------------------------------------------ |
| P0 文档空间进入真实内容阶段       | 是 真实上传、订阅同步、文档浏览器、内容搜索、划词评论和访客统计全部落地                         |
| P0 CDS 统一生产入口与稳定性     | 是 单入口脚本、多根域名、server authority、self-update、resilience 一整周都在推进 |
| P1 PR 审查与 GitHub 基础设施 | 是 PR Review V2 的 OAuth、摘要、错误治理和 GitHub infra 分层一起成型          |
| P1 首页与登录品牌重写          | 是 九幕式 landing 和统一登录页视觉语言全部完成                                 |
| P2 汇报型产品的通知统一         | 警告 周报数据口径继续修复，但跨周报/评审/其他产品的统一通知策略仍未完全收束                      |
...
| PR   | 标题                          | 分类        |
| ---- | --------------------------- | --------- |
| #370 | 文档技能澄清与周边 QA 技能收敛           | 文档 文档     |
| #371 | 首页产品页方向并入主线                 | 界面 UI/UX  |
| #372 | CDS 数据迁移功能首版                | 新功能 新功能     |
| #373 | 转录工作台彻底整改                   | 修复 Bug 修复 |
| #374 | 网页自动化与 Agent Web 补点         | 工作流 工作流    |
| #375 | PR 审查棱镜阶段性能力并入              | AI AI 能力  |
| #376 | CDS 部署指示与入口收敛               | 运维 DevOps |
| #377 | Cursor 分支并入与冲突收敛            | 更新 更新     |
| #378 | 知识库真实上传与订阅同步                | 新功能 新功能     |
| #379 | 缺陷批量分享仅保留打开项                | 修复 Bug 修复 |
| #380 | 缺陷数量展示与统计修复                 | 修复 Bug 修复 |
| #382 | CDS 预览模式改为服务器权威             | 修复 Bug 修复 |
| #384 | 域名与文档引用更新                   | 文档 文档     |
| #385 | 知识库导航搜索上线                   | 新功能 新功能     |
| #386 | 知识库真实性校验与阅读器增强              | 更新 更新     |
| #387 | 知识库重命名与标签支持                 | 新功能 新功能     |
| #388 | 智能体入口与引导优化                  | 界面 UI/UX  |
| #389 | 订阅详情与同步日志                   | 新功能 新功能     |
| #390 | CDS nginx 初始化 Part 1        | 运维 DevOps |
| #391 | CDS nginx 初始化 Part 2        | 运维 DevOps |
| #392 | CDS nginx 初始化 Part 3        | 运维 DevOps |
| #393 | Dashboard 根域名接入             | 运维 DevOps |
| #394 | Dashboard 与预览域名拆分           | 运维 DevOps |
| #395 | CDS 宿主机负载与容量能力设计并入          | 运维 DevOps |
| #396 | CDS 根目录入口统一                 | 运维 DevOps |
| #397 | CDS 根域名路由进一步简化              | 运维 DevOps |
| #398 | CDS v3.2 统一入口与多域名设计沉淀       | 文档 文档     |
| #399 | 容量电池改为显示剩余槽位                | 界面 UI/UX  |
| #401 | 修复 `/local-dump` 0 字节问题     | 修复 Bug 修复 |
| #402 | 周报 Agent 口径、自噬与提示词修复        | 修复 Bug 修复 |
| #403 | 技能引导 Agent 上线               | 新功能 新功能     |
| #404 | CDS 集群与调度能力继续推进             | 新功能 新功能     |
| #405 | 首页九幕式重写并入主线                 | 界面 UI/UX  |
| #407 | CDS 集群 UI 与视图问题修复           | 修复 Bug 修复 |
| #408 | 登录页视觉体系重写                   | 界面 UI/UX  |
| #409 | GitHub 基础设施分层抽取             | 架构 架构    |
| #410 | 权限与环境问题排查收束                 | 安全 权限     |
| #411 | 首页语言加载修复                    | 修复 Bug 修复 |
| #412 | 多对象存储 / Cloudflare R2 研究与接入 | 架构 架构    |
