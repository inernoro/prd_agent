...
const NAV_GROUPS: NavGroup[] = [
  ...
  { label: '路由', items: [
    { to: '/pools', label: '模型池', icon: <Boxes size={16} /> },
    { to: '/platforms', label: 'Provider', icon: <Server size={16} /> },
    { to: '/models', label: '模型', icon: <Cpu size={16} /> },
    { to: '/exchanges', label: 'Exchange', icon: <Shuffle size={16} /> },
  ] },
  { label: '开发者', items: [
  ...
  return (
    <div className="lg-console-shell">
      <header className="lg-console-header">
        ...
        <form className="lg-global-search" role="search" onSubmit={submitSearch}>
          <Search size={15} />
